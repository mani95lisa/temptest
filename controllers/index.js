...
(function() {
  'use strict';
  var API, Dict, EventProxy, Lottery, LotteryRecord, Token, User, api, appid, auth, code_url, getConfig, getParams, getRewardNumber, getToken, getUrl, get_js_sdk_ticket, home_url, host, inTime, logger, menu, models, moment, regist_url, request, saveToken, save_js_sdk_ticket, secret, utils;

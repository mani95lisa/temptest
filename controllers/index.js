...
(function() {
  'use strict';
  var API, Dict, EventProxy, LINK_ERROR, Lottery, LotteryRecord, OAuth, SYSTEM_ERROR, TIME_OUT_ERROR, Token, UpdateObject, User, WEIXIN_AUTH_ERROR, api, appid, auth, client, code_url, errorHandler, getConfig, getParams, getRewardNumber, getToken, getUrl, getUserToken, get_js_sdk_ticket, home_url, host, inTime, logger, menu, models, moment, regist_url, request, saveToken, saveUserToken, save_js_sdk_ticket, secret, sign_in_url, utils;

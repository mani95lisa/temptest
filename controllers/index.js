...
(function() {
  'use strict';
  var API, Dict, EventProxy, Lottery, LotteryRecord, OAuth, Token, UpdateObject, User, api, appid, auth, client, code_url, getConfig, getParams, getRewardNumber, getToken, getUrl, getUserToken, get_js_sdk_ticket, home_url, host, inTime, logger, menu, models, moment, regist_url, request, saveToken, saveUserToken, save_js_sdk_ticket, secret, sign_in_url, utils;

...
(function() {
  'use strict';
  var EventProxy, Lottery, LotteryRecord, Manager, User, auth, logger, models, moment, passport, sms;
  ...
  module.exports = function(router) {
    ...
    return router.get('/count', auth.isAuthenticated(), function(req, res) {
      var ep, now;
      ep = new EventProxy();
      ep.all('user', 'user1', 'user2', 'user3', 'lottery', 'record', 'got', 'dispatched', 'sms', function(c1, nu, nru, user3, c2, c3, c4, c5, sms) {
        return res.json({
          user: c1,
          user1: nu,
          user2: nru,

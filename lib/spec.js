...
(function() {
  'use strict';
  var API, EventProxy, LotteryRecord, Token, User, api, appid, auth, connect, getToken, initUser, logger, mongo, passport, saveToken, secret, wechat;
  ...
  module.exports = function(app) {
    ...
    app.use('/wechat', wechat(config, function(req, res, next) {
      var address, arr, content, ep, lid, message, mobile, openid, saveInfo, truename, wxsession;
      message = req.weixin;
      ...
      if (message.Event === 'subscribe') {
        ...
        if (content === '领奖') {
          ...
          }).populate('lottery', 'name').exec(function(err, result) {
            var s;
            if (err) {

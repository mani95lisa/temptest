    ...
    return function($scope, $http, uiGridConstants, $modal, $interval, $location) {
      ...
      addProduct = function() {
        ...
        return modalInstance.result.then(function(data) {
          if (data._id) {
            return $http.post('/m/product/update', data).success(function(result) {
              if (result.err) {
            ...
            console.log(data);
            return $http.post('/m/product/add', data).success(function(result) {
              if (result.err) {
      ...
      $scope.getData = function() {
        ...
        return $http.get('/m/product/list', {
          params: {
            page: $scope.page,

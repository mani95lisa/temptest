...
(function() {
  var count, downHandler, enablePlay, gotR, handleComplete, handleFileLoad, handleProgress, home_arr, i, imgArr, init, initP1, initP2, initP3, initP5, initP6, inited3, intv, leftHandler, lid, load, lotteryBGS, loveItem, loveNumArr, manifest1, max_page, p1, p5, p6p1, p6p2, p6try, page_index, pageplaying, playVideoImg, playing, refresh, requesting, rightHandler, selectP3Slide, selectP4Slide, showImg, slide_index, toPageSlide, upHandler, value, videoEnded, videoplaying;
  ...
  loveItem = function(event) {
    ...
    return $(this).siblings('label').text('x' + num);
  };

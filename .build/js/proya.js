...
(function() {
  var count, downHandler, handleComplete, handleFileLoad, handleProgress, home_arr, i, imgArr, init, initP1, initP2, initP3, initP5, initP6, intv, leftHandler, load, loveItem, loveNum, manifest1, max_page, p1, p6p1, p6p2, p6try, page_index, playing, refresh, rightHandler, selectP3Slide, selectP4Slide, showImg, slideChange, slide_index, toPageSlide, upHandler, videoEnded;
  ...
  toPageSlide = function(fromtop, page, slide) {
    var hidec, hidetop, old, showtop, toc;
    ...
    toc = fromtop ? 'animated zoomInDown' : 'animated zoomInUp';
  ...
  selectP3Slide = function(left, select) {
    ...
    if (select) {
      ...
      froml = left ? this.ww : -this.ww;
      toc = left ? 'animated zoomInRight' : 'animated zoomInLeft';
      console.log(hidec, toc);

...
var step3_width=W_Width*566/1524;
...
function setTableHeight(){
	...
	$('.flipper .img-i').click(function(){
		...
		if(arr.indexOf(id) != -1){
			p1default.animate({opacity:0},{duration:500, complete:function(){
...
var initP3 = function(){
	...
	$('.p3m').eq(0).css({opacity:0,width:bigw,left:centerl,top:centert});	
	$('.p3t').eq(0).css({left:(step3_width-358)/2});
	$('.p3i').eq(0).css({width:142*p3scale});
	...
	for(var i=1; i<5; i++){
		preleft = centerl+bigw-80*p3scale+ (38+bigw*zoomS)*i;
...
var onLeave = function(index, nextIndex){
	if(nextIndex == 3){
		...
		$('.p3m').eq(index_a).css({opacity:0});
		$('.p3i').eq(index_a).css({opacity:0});
		$('.p3m').eq(index_a).animate({opacity:1},{duration:1500,complete:function(){
			$('.p3t').eq(index_a).animate({opacity:1},{duration:500,complete:function(){
				$('.p3i').eq(index_a).animate({opacity:1},{duration:500});
			}})
		}})
	}
};
...
var onLeave = function(index, nextIndex){
	if(nextIndex == 3){
		...
		$('#p41').animate({opacity:0},{duration:1500,complete:function(){
			$('#p42').animate({opacity:0},{duration:500,complete:function(){
				$('#p43').animate({opacity:0},{duration:500,complete:function(){
					$('#p44').animate({opacity:0},{duration:500,complete:function(){
						$('#p45').animate({opacity:0},{duration:500,complete:function(){
